...
#Top 10 County Incarceration Rates
  ...
  #2 Forest County, PA
      Forest County, Pennsylvania has a total population of 6,973 and the incarcerated population is       2,653, a rate of approximately 38%. 
  ...
  #10 Lake County, TN
```{r}
zipstocounty <- read_excel("ZIP_COUNTY_122021.xlsx")
  take fipps codes from census data and then add the fipps codes to the prison locations and then put the join the zip codes from the zip codes/fipps per county with the counties in the prison locations
``` 
